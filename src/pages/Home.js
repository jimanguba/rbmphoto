    ...
    <div className='container mx-auto h-full relative'>
      ...
      <div className='flex flex-col justify-center'>
        ...
        <div className='w-full pt-36 pb-14 lg:pt-0 lg:pb-0 lg:w-auto z-10 lg:absolute flex flex-col justify-center items-center lg:items-start'>
          <h1 className='h1'>RBM <br/> Photo Booth</h1>
          <p className='text-[26px] lg:text-[36px] font-primary mb-4 lg:mb-12'> Winnipeg, MB</p>
          <Link to={'/rbmphoto/contact'} className='btn mb-[30px]'>book now</Link>
        </div>
        {/* image */}
